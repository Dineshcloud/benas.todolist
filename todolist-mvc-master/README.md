...
Todolist MVC is like [TodoMVC][] but for Java Web Frameworks 
...
Other frameworks will be added progressively (JSR 371, Wicket, Grails, Play, etc..), 
...
1.  Check out the project source code from github : `git clone https://github.com/Dineshcloud/benas.todolist.git`
